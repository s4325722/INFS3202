...
function dart_precompiled($collectedClasses) {
  ...
  function JsObject__convertDataTree__convert(_js$_convertedObjects_0) {
    this._js$_convertedObjects_0 = _js$_convertedObjects_0;
  }
  ...
  function GeocoderAddressComponent($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  GeocoderAddressComponent.builtin$cls = "GeocoderAddressComponent";
  if (!"name" in GeocoderAddressComponent)
    GeocoderAddressComponent.name = "GeocoderAddressComponent";
  $desc = $collectedClasses.GeocoderAddressComponent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GeocoderAddressComponent.prototype = $desc;
  ...
  function PlacesService_radarSearch_closure(callback_0) {
    this.callback_0 = callback_0;
  }
  PlacesService_radarSearch_closure.builtin$cls = "PlacesService_radarSearch_closure";
  if (!"name" in PlacesService_radarSearch_closure)
    PlacesService_radarSearch_closure.name = "PlacesService_radarSearch_closure";
  $desc = $collectedClasses.PlacesService_radarSearch_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlacesService_radarSearch_closure.prototype = $desc;
  ...
  function RadarSearchRequest($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  RadarSearchRequest.builtin$cls = "RadarSearchRequest";
  if (!"name" in RadarSearchRequest)
    RadarSearchRequest.name = "RadarSearchRequest";
  $desc = $collectedClasses.RadarSearchRequest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RadarSearchRequest.prototype = $desc;
  ...
  function EnumFinder_find_closure(this_0, o_1) {
    this.this_0 = this_0;
    this.o_1 = o_1;
  }
