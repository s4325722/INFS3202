...
class AdminController extends Controller
{
    ...
    {
        return $this->redirect($this->generateUrl('infs3202_practicalfive_admin_alldeals'));
    }
    ...
    {
        $deals = $this->getDoctrine()->getRepository('INFS3202PracticalFiveBundle:Deal')->findAll();
    ...
    public function createDealAction(Request $request)
    {
        ...
        $proprietorRepository = $em->getRepository('INFS3202PracticalFiveBundle:Proprietor');
