...
class UpdateDealModel extends ContainerAware {
    ...
    public function setDeal($deal){
        if($deal != null){
            ...
            $reviewRepository = $this->container->get('doctrine')->getRepository('INFS3202PracticalFourBundle:Review');
    ...
    public function validate(ExecutionContextInterface $context)
    {
        ...
        $existingDeal = $em->getRepository('INFS3202PracticalFourBundle:Deal')->findOneBy(['title' => $this->getDealTitle()]);
